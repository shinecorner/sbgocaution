...
<link rel="stylesheet" href="{{asset('Login/assets/styles/vendor/smart.wizard/smart_wizard_theme_circles.min.css')}}">
<link rel="stylesheet" href="{{asset('Login/assets/styles/vendor/smart.wizard/smart_wizard_theme_dots.min.css')}}">
...
@section('page-js')
 ...
 <script src="{{asset('Login/assets/js/vendor/jquery.smartWizard.min.js')}}"></script>
...
@section('bottom-js')
 ...
 <script src="{{asset('Login/assets/js/smart.wizard.script.js')}}"></script>

...
@section('before-css')
 <link rel="stylesheet" href="{{asset('Login/assets/styles/vendor/pickadate/classic.css')}}">
 <link rel="stylesheet" href="{{asset('Login/assets/styles/vendor/pickadate/classic.date.css')}}">
...
@section('page-js')
<script src="{{asset('Login/assets/js/vendor/pickadate/picker.js')}}"></script>
<script src="{{asset('Login/assets/js/vendor/pickadate/picker.date.js')}}"></script>
...
@section('bottom-js')
<script src="{{asset('Login/assets/js/form.basic.script.js')}}"></script>

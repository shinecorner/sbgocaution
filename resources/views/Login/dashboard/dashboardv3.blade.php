                    ...
                    <div class="row">
                         ...
                         <div class="col-md-12">
                            <div class="card card-ecommerce-3 o-hidden mb-4">
                                <div class="d-flex flex-column flex-sm-row">
                                    <div class="">
                                        <img class="card-img-left" src="{{asset('Login/assets/images/photo-wide-1.jpg')}}" alt="">
                                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card card-ecommerce-3 o-hidden mb-4">
                                <div class="d-flex flex-column flex-sm-row">
                                    <div class="">
                                        <img class="card-img-left" src="{{asset('Login/assets/images/photo-wide-2.jpg')}}" alt="">
                                    </div>
                                    <div class="flex-grow-1 p-4">
                                        <h5 class="m-0">Product featured</h5>
...
@section('page-js')
     <script src="{{asset('Login/assets/js/vendor/echarts.min.js')}}"></script>
     <script src="{{asset('Login/assets/js/es5/echart.options.min.js')}}"></script>
     <script src="{{asset('Login/assets/js/es5/dashboard.v3.script.js')}}"></script>

                ...
                <table align="center" width="600" class="tableshrink" bgcolor="#8DBF43" style="background-color:#8DBF43;">
                    ...
                    <tr>
                        ...
                        <td style="line-height: 0px;" width="340"  class="block-header">
                            <img class="logo-img" src="{{ asset('customer/assets/images/'.__('customer/login.LOGO_IMG')) }}" alt="{{ __('customer/login.TITLE') }}" />
                        </td>
                        <td width="200"></td>
                        <td width="30"></td>
                            ...
                            <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tr>
                                    <td style="color:#7a7a7a;">
                                        {{__('customer/regrequest.REG_REQUEST_HEADLINE')}}
                                    </td>
                                </tr>
                                <tr height="20">
                                    <td></td>
                                ...
                                <tr>
                                    <td style="color:#7a7a7a;">
                                        {{ __('customer/regrequest.FORM_FIELDS.FIRSTNAME') }} :
                                    </td>
                                    <td style="color:#7a7a7a;">
                                        {{$data['firstname']}}
                                    </td>
                                ...
                                <tr>
                                    <td style="color:#7a7a7a;">
                                        {{ __('customer/regrequest.FORM_FIELDS.NAME') }} :
                                    </td>
                                    <td style="color:#7a7a7a;">
                                        {{$data['lastname']}}
                                    </td>
                                ...
                                <tr>
                                    <td style="color:#7a7a7a;">
                                        {{ __('customer/regrequest.FORM_FIELDS.DOB') }} :
                                    </td>
                                    <td style="color:#7a7a7a;">
                                        {{$data['dob']}}
                                    </td>
                                ...
                                <tr>
                                    <td style="color:#7a7a7a;">
                                        {{ __('customer/regrequest.FORM_FIELDS.MOBILE') }} :
                                    </td>
                                    <td style="color:#7a7a7a;">
                                        {{$data['mobile']}}
                                    </td>
                                ...
                                <tr>
                                    <td style="color:#7a7a7a;">
                                        {{ __('customer/regrequest.FORM_FIELDS.EMAIL') }} :
                                    </td>
                                    <td style="color:#7a7a7a;">
                                        {{$data['email']}}
                                    </td>

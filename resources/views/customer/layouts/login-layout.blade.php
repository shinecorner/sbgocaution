                    ...
                    <div class="login-header-block visible-xs">
                        <div class="logo">
                            <div class="logo-image">
                                <a href="#" title="{{ __('customer.title') }}">
            ...
            <div class="container">
                <div class="main_box">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="left_box">
                                <h1>{{__('customer.YOUR_RENTAL_DEPOSIT_ALWAYS_IN_REACH')}}</h1>
                                <hr>
                                <p>{{__('customer.YOUR_RENTAL_DEPOSIT_ALWAYS_IN_REACH_DESCRIPTION')}}</p>
                                <div class="column_box">
                                    <div class="col-md-4 text-center">
                                        <div class="box_1">
                                            <i class="fa fa-file-text" aria-hidden="true"></i>
                                            <h2>{{__('customer.AT_A_GLANCE')}}</h2>
                                            <p>{{__('customer.AT_A_GLANCE_DESCRIPTION')}}</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4 text-center">
                                        <div class="box_1">
                                            <i class="fa fa-pencil" aria-hidden="true"></i>
                                            <h2>{{__('customer.REPORT_MOVE')}}</h2>
                                            <p>{{__('customer.REPORT_MOVE_DESCRIPTION')}}</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4 text-center">
                                        <div class="box_1">
                                            <i class="fa fa-commenting" aria-hidden="true"></i>
                                            <h2>{{__('customer.FAST_SUPPORT')}}</h2>
                                            <p>{{__('customer.FAST_SUPPORT_DESCRIPTION')}}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="right_box">
                                <h1>{{__('customer.DO_YOU_NEED_HELP')}}</h1>
                                <hr>
                                <div class="box_2">
                                    <p>{{__('customer.DO_YOU_NEED_HELP_DESCRIPTION')}}</p>

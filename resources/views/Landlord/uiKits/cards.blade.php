                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="card bg-dark text-white o-hidden mb-4">
                                <img class="card-img" src="{{asset('Login/assets/images/photo-wide-2.jpg')}}" alt="Card image">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="card mb-4 o-hidden">
                                <img class="card-img-top" src="{{asset('Login/assets/images/photo-wide-2.jpg')}}" alt="">
                                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="card mb-4 o-hidden">
                                <img class="card-img-top" src="{{asset('Login/assets/images/photo-wide-3.jpg')}}" alt="">
                                <div class="card-body">
                                    <h5 class="card-title">Card title</h5>
                                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.
                                    </p>

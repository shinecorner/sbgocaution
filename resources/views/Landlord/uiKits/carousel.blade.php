                                ...
                                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img class="d-block w-100" src="{{asset('Login/assets/images/products/iphone-1.jpg')}}" alt="First slide">
                                        </div>
                                        <div class="carousel-item">
                                            <img class="d-block w-100" src="{{asset('Login/assets/images/products/headphone-1.jpg')}}" alt="Second slide">
                                        </div>
                                        <div class="carousel-item">
                                            <img class="d-block w-100" src="{{asset('Login/assets/images/products/iphone-1.jpg')}}" alt="Third slide">
                                        </div>
                                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="carousel_wrap">
                                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img class="d-block w-100" src="{{asset('Login/assets/images/products/headphone-1.jpg')}}" alt="First slide">
                                        </div>
                                        <div class="carousel-item">
                                            <img class="d-block w-100" src="{{asset('Login/assets/images/products/iphone-1.jpg')}}" alt="Second slide">
                                        </div>
                                        <div class="carousel-item">
                                            <img class="d-block w-100" src="{{asset('Login/assets/images/products/headphone-1.jpg')}}" alt="Third slide">
                                        </div>
                                    </div>
...
@section('page-js')
<script src="{{asset('Login/assets/js/carousel.script.js')}}"></script>
@endsection

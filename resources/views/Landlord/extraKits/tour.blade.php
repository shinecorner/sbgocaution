...
@section('page-css')
  <link rel="stylesheet" href="{{asset('Login/assets/styles/vendor/hopscotch.css')}}">
@endsection
...
@section('page-js')
 ...
 <script src="{{asset('Login/assets/js/vendor/hopscotch.min.js')}}"></script>
<script src="{{asset('Login/assets/js/hopscotch.script.js')}}"></script>
@endsection

...
@section('page-css')
     <link rel="stylesheet" href="{{asset('Login/assets/styles/vendor/cropper.min.css')}}">
@endsection
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    <div class="img-container o-hidden">
                                        <img class="cropper-main-img img-fluid" src="{{asset('Login/assets/images/photo-wide-1.jpg')}}" alt="Picture">
                                    </div>
                                </div>
                                <div class="col-md-3">
...
@section('page-js')
<script src="{{asset('Login/assets/js/vendor/cropper.min.js')}}"></script>
<script src="{{asset('Login/assets/js/cropper.script.js')}}"></script>
@endsection

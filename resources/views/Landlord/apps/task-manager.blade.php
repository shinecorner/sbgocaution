                                    ...
                                    <div class="card-body">
                                        <div class="d-sm-flex align-item-sm-center flex-sm-nowrap">
                                            <div>
                                                ...
                                                <a href="#">
                                                    <img src="{{asset('Login/assets/images/faces/1.jpg')}}" class="rounded-circle" width="36" height="36" alt="corrupted">
                                                </a>
                                                <a href="#">
                                                    <img src="{{asset('Login/assets/images/faces/1.jpg')}}" class="rounded-circle" width="36" height="36" alt="corrupted 2">
                                                </a>
                                                <a href="#">
                                                    <img src="{{asset('Login/assets/images/faces/1.jpg')}}" class="rounded-circle" width="36" height="36" alt="corrupted 2">
                                                </a>
                        ...
                        <div class="card  mb-3">
                            ...
                            <div class="card-body" id="custom-toggle4">
                                <ul class="media-list">
                                    <li class="media mb-2">
                                        <a href="#" class="mr-4">
                                            <img src="{{asset('Login/assets/images/faces/1.jpg')}}" class="rounded-circle" width="36" alt="asd" srcset="">
                                        </a>
...
<script src="{{asset('Login/assets/js/es5/task-manager.min.js')}}"></script>

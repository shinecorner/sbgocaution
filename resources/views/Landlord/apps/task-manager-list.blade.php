                                    ...
                                    <tbody id="names">
                                        ...
                                        <tr id="names">
                                            ...
                                            <td class="custom-align">
                                                ...
                                                <img class="rounded-circle m-0 ul-task-manager__avatar " src="/Login/assets/images/faces/1.jpg" alt="">
                                                <img class="rounded-circle m-0 ul-task-manager__avatar " src="/Login/assets/images/faces/1.jpg" alt="">
...
<script src="{{asset('Login/assets/js/es5/task-manager-list.min.js')}}"></script>

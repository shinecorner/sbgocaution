...
@section('page-css')
    <link rel="stylesheet" href="{{asset('Login/assets/styles/vendor/quill.bubble.css')}}">
    <link rel="stylesheet" href="{{asset('Login/assets/styles/vendor/quill.snow.css')}}">
@endsection
...
@section('page-js')
  ...
  <script src=""></script>
    <!-- <script src="Login/assets/js/es5/echart.options.min.js"></script> -->
    <script src=""></script>

    <script src="{{asset('Login/assets/js/vendor/echarts.min.js')}}"></script>
    <script src="{{asset('Login/assets/js/es5/echarts.script.min.js')}}"></script>

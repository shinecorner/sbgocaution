                ...
                <section class="widget-card">
                    <div class="row">
                        <div class="col-lg-4 col-xl-4 mt-3">
                            <div class="card">
                                <img class="d-block w-100 rounded rounded" src="{{asset('Login/assets/images/products/iphone-1.jpg')}}" alt="First slide">
                                <div class="card-body">
                        ...
                        <div class="col-lg-4 col-xl-4 mt-3">
                            <div class="card">
                                <div class="card-body">
                                    <img class="d-block w-100 rounded" src="{{asset('Login/assets/images/products/headphone-1.jpg')}}" alt="Second slide">
                        ...
                        <div class="col-lg-4 col-xl-4 mt-3">
                            <div class="card">
                                <div class="card-body">
                                    <img class="d-block w-100 rounded" src="{{asset('Login/assets/images/products/iphone-1.jpg')}}" alt="First slide">
                                    <h5 class="card-title mt-4 mb-2">Gull Admin</h5>
                        ...
                        <div class="col-lg-4 col-xl-4 mt-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="user-profile mb-4">
                                        <div class="ul-widget-card__user-info">
                                            <img class="profile-picture avatar-lg mb-2" src="{{asset('Login/assets/images/faces/5.jpg')}}" alt="">
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-4 col-xl-4 mt-3">
                            <div class="card">
                                <div class="card-body">
                                    <div class="user-profile mb-4">
                                        <div class="ul-widget-card__user-info">
                                            <img class="profile-picture avatar-lg mb-2" src="{{asset('Login/assets/images/faces/2.jpg')}}" alt="">
                        ...
                        <div class="col-md-4 mt-3">
                            <div class="card bg-dark text-white o-hidden mb-4">
                                <img class="card-img" src="{{asset('Login/assets/images/photo-long-1.jpg')}}" alt="Card image">
                        ...
                        <div class="col-md-4 mt-3">
                            <div class="card bg-dark text-white o-hidden mb-4">
                                <img class="card-img" src="{{asset('Login/assets/images/photo-long-2.jpg')}}" alt="Card image">
                                <div class="card-img-overlay">

...
@section('page-css')
    <link rel="stylesheet" href="{{asset('Login/assets/styles/vendor/nuslider.min.css')}}">
@endsection
...
@section('page-js')
<script src="{{asset('Login/assets/js/vendor/nuslider.min.js')}}"></script>
<script src="{{asset('Login/assets/js/nuslider.script.js')}}"></script>
@endsection

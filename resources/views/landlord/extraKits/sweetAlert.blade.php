...
@section('page-css')
  <link rel="stylesheet" href="{{asset('Login/assets/styles/vendor/sweetalert2.min.css')}}">
@endsection
...
@section('page-js')
 <script src="{{asset('Login/assets/js/vendor/sweetalert2.min.js')}}"></script>
<script src="{{asset('Login/assets/js/sweetalert.script.js')}}"></script>
@endsection

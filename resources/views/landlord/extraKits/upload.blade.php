...
@section('page-css')
  <link rel="stylesheet" href="{{asset('Login/assets/styles/vendor/dropzone.min.css')}}">
@endsection
...
@section('page-js')
 ...
 <script src="{{asset('Login/assets/js/vendor/dropzone.min.js')}}"></script>
<script src="{{asset('Login/assets/js/dropzone.script.js')}}"></script>
@endsection

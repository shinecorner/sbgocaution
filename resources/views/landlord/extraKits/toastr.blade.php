...
@section('page-css')
<link rel="stylesheet" href="{{asset('Login/assets/styles/vendor/toastr.css')}}">
@endsection
...
@section('page-js')
 ...
 <script src="{{asset('Login/assets/js/vendor/toastr.min.js')}}"></script>
    <script src="{{asset('Login/assets/js/toastr.script.js')}}"></script>

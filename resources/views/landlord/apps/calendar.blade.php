...
@section('page-css')
  ...
  <link rel="stylesheet" href="{{asset('Login/assets/styles/vendor/calendar/fullcalendar.min.css')}}">
@endsection
...
<script src="{{asset('Login/assets/js/vendor/calendar/jquery-ui.min.js')}}"></script>
<script src="{{asset('Login/assets/js/vendor/calendar/moment.min.js')}}"></script>
<script src="{{asset('Login/assets/js/vendor/calendar/fullcalendar.min.js')}}"></script>
<script src="{{asset('Login/assets/js/calendar.script.js')}}"></script>

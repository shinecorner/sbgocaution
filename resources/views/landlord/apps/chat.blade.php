                    ...
                    <div class="border-right">
                        ...
                        <div class="contacts-scrollable perfect-scrollbar">
                            ...
                            <div class="p-3 d-flex align-items-center border-bottom online contact">
                                <img src="{{asset('Login/assets/images/faces/13.jpg')}}" class="avatar-sm rounded-circle mr-3" alt="">
                                <div>
                            ...
                            <div class="p-3 d-flex border-bottom align-items-center contact online">
                                <img src="{{asset('Login/assets/images/faces/3.jpg')}}" alt="" class="avatar-sm rounded-circle mr-3">
                ...
                <div data-sidebar-content="chat" class="chat-content-wrap">
                    <div class="d-flex pl-3 pr-3 pt-2 pb-2 o-hidden box-shadow-1 chat-topbar">
                        ...
                        <div class="d-flex align-items-center">
                            <img src="{{asset('Login/assets/images/faces/13.jpg')}}" alt="" class="avatar-sm rounded-circle mr-2">
                    ...
                    <div class="chat-content perfect-scrollbar" data-suppress-scroll-x="true">
                        <div class="d-flex mb-4">
                            ...
                            <img src="{{asset('Login/assets/images/faces/13.jpg')}}" alt="" class="avatar-sm rounded-circle ml-3">
                        </div>

                        <div class="d-flex mb-4 user">
                            <img src="{{asset('Login/assets/images/faces/1.jpg')}}" alt="" class="avatar-sm rounded-circle mr-3">
                            <div class="message flex-grow-1">
                                <div class="d-flex">
...
@section('bottom-js')
 ...
 <script src="{{asset('Login/assets/js/sidebar.script.js')}}"></script>

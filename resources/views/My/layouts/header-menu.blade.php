                ...
                <div class="dropdown">
                    <div  class="user col align-self-end">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                            ...
                            <a class="dropdown-item" href="{{ url(LaravelLocalization::getURLFromRouteNameTranslated(app()->getLocale(),'my.routes.LOGOUT')) }}"
                               onclick="event.preventDefault();
                                             document.getElementById('logout-form').submit();">
                                Sign out
                            </a>
                            <form id="logout-form" action="{{ url(LaravelLocalization::getURLFromRouteNameTranslated(app()->getLocale(),'my.routes.LOGOUT')) }}" method="POST" style="display: none;">
                                @csrf
                            </form>
                        </div>
                    </div>

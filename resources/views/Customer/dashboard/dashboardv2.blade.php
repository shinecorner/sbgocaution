                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center border-bottom-dotted-dim pb-3 mb-3">
                                <img class="avatar-md rounded mr-3" src="{{asset('Login/assets/images/faces/2.jpg')}}" alt="">
                            ...
                            <div class="d-flex align-items-center border-bottom-dotted-dim pb-3 mb-3">
                                <img class="avatar-md rounded mr-3" src="{{asset('Login/assets/images/faces/3.jpg')}}" alt="">
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center border-bottom-dotted-dim pb-3 mb-3">
                                <img class="avatar-md rounded mr-3" src="{{asset('Login/assets/images/faces/4.jpg')}}" alt="">
                                <div class="flex-grow-1">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <img class="rounded-circle m-0 avatar-sm-table " src="{{asset('Login/assets/images/faces/1.jpg')}}" alt="">
...
@section('page-js')
     ...
     <script src="{{asset('Login/assets/js/es5/echart.options.min.js')}}"></script>
      <script src="{{asset('Login/assets/js/vendor/datatables.min.js')}}"></script>
     <script src="{{asset('Login/assets/js/es5/dashboard.v2.script.js')}}"></script>

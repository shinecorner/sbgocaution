                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <img class="rounded-circle m-0 avatar-sm-table " src="/Login/assets/images/faces/1.jpg" alt="">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-column flex-sm-row align-items-center mb-3">
                                <img class="avatar-lg mb-3 mb-sm-0 rounded mr-sm-3" src="{{asset('Login/assets/images/products/headphone-4.jpg')}}" alt="">
                            ...
                            <div class="d-flex flex-column flex-sm-row align-items-center mb-3">
                                <img class="avatar-lg mb-3 mb-sm-0 rounded mr-sm-3" src="{{asset('Login/assets/images/products/headphone-2.jpg')}}" alt="">
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex flex-column flex-sm-row align-items-center mb-3">
                                <img class="avatar-lg mb-3 mb-sm-0 rounded mr-sm-3" src="{{asset('Login/assets/images/products/headphone-3.jpg')}}" alt="">
                                <div class="flex-grow-1">
...
@section('page-js')
    {{-- <script src="{{asset('Login/assets/js/vendor/echarts.min.js')}}"></script>
     ...
     <script src="{{asset('Login/assets/js/es5/dashboard.v1.script.js')}}"></script>
--}}
@endsection
